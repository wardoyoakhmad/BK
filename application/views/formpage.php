...
<html lang="en">
  ...
  <section id="container" >
   ...
   <script src="<?= base_url().'asset/js/jquery.js';?>"></script>
	...
	<!--custom tagsinput-->
	<script src="<?= base_url().'asset/js/jquery.tagsinput.js';?>"></script>
	
	<!--custom checkbox & radio-->
	
	<script type="text/javascript" src="<?= base_url().'asset/js/bootstrap-datepicker/js/bootstrap-datepicker.js';?>"></script>
	<script type="text/javascript" src="<?= base_url().'asset/js/bootstrap-daterangepicker/date.js';?>"></script>
	<script type="text/javascript" src="<?= base_url().'asset/js/bootstrap-daterangepicker/daterangepicker.js';?>"></script>
	
	<script type="text/javascript" src="<?= base_url().'asset/js/bootstrap-inputmask.min.js';?>"></script>
	
	
	<script src="<?= base_url().'asset/js/form-component.js';?>"></script>    
